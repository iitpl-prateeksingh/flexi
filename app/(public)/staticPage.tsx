...
const StaticPage = ({ pageType }: { pageType: string }) => {
  ...
  return (
    <div className="min-h-screen bg-white static-page">
      {/* Header */}
      <div className="bg-[#0A2540] text-white py-12   text-center"></div>

      {/* Content */}
      <div className="max-w-6xl mx-auto py-10">
        <h1 className="text-3xl mt-5 font-semibold">{data.pageTitle}</h1>
