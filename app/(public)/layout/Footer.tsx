...
const Footer = ({ data }: any) => {
  ...
  return (
    <footer className="bg-[#032E52] text-white py-8 px-6 md:px-12 lg:px-20 font-inter">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 items-start mb-4">
        ...
        <div className="md:col-span-4 flex flex-col items-center text-center">
          ...
          <ul className="space-y-4 text-sm">
            ...
            {/* Dynamic Blogs */}
            <li>
              <Link href={`/blogs/monthly`}>Monthly Market Outlook</Link>
            </li>

            <li>
              <Link href={`/blogs/weekly`}>Weekly Flexi Wrap</Link>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            {data?.address && (
              <li className="flex items-start space-x-4">
                ...
                <div className="leading-relaxed">{data.address}</div>
              </li>
            )}
          </ul>
        </div>
      ...
      {/* BOTTOM */}
      <div
        className="max-w-7xl mx-auto flex flex-col items-center text-center space-y-6"
