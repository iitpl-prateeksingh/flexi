...
export default function CodeOfConductRevised() {
  ...
  const fetchPage = async () => {
    try {
      ...
      const res = await getStaticPageService("code-of-conduct-revised");
  ...
  const handleSave = async () => {
    try {
      ...
      await saveStaticPageService({
        ...
        content,
        pageType: "code-of-conduct-revised"
      });
      ...
      <div className="bg-white shadow rounded-lg  p-6">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500 text-sm">
            Edit and save your Code of Conduct revised content.
          </p>
        </div>
